...
public class BusquedaDerechaFiltros<T extends Comparable<T>> extends Thread {
    ...
    public BusquedaDerechaFiltros(BinaryNode<Artista> nodo, String genero, String anioLanzamiento, String duracion) {
        this.nodo = nodo;
        this.genero = genero;
    ...
    private void buscarCancionesUnaCondicion(BinaryNode<Artista> nodo) {
        if (nodo != null) {
            ...
            buscarCancionesUnaCondicion(nodo.getRightNode());
    ...
    private void buscarCancionesTodasCondiciones(BinaryNode<Artista> nodo) {
        if (nodo != null) {
            ...
            buscarCancionesTodasCondiciones(nodo.getRightNode());
